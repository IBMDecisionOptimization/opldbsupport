...
import ilog.concert.*;
import ilog.opl.*;
import ilog.opl.externaldata.excel.ExcelConnection;
...
public class OplRunSample {
    ...
    int run() throws Exception {
        ...
        // This is the place in which data sources should be registered
        if ( false ) {
        	// This enables statements ExcelConnection, ExcelRead, ExcelPublish in .dat files.
        	ExcelConnection.register("Excel", opl);
        }
        if ( false ) {
        	// This enabled statements JDBCConnection, JDBCRead, JDBCPublish in .dat files.
        	JdbcConnection.register("JDBC", opl);
        }
